...
public class Book {
	...
	String dir = "C:\\Users\\rmadhavan\\workspace\\metric\\src\\main\\java\\metric\\";
	...
	private void extractTokens() throws Exception {
		InputStream is = new FileInputStream(dir+"en-token.bin");
	...
	private void extractSentences() throws Exception {
		InputStream modelIn = new FileInputStream(dir+"en-sent.bin");
